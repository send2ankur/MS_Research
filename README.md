...
Data Source:
1. CAAQMS - Continuous Ambient Air Qaulity Monitoring Station maintained by CPCB and state pollution boards
2. DarkSky - Historical and forecasted weather data
